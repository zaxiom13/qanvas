...
- Name: app/test/browser/mobile-shell.spec.ts >> keeps the bottom navigation out of the active screen content
- Location: app/test/browser/mobile-shell.spec.ts:19:1
